...
public class FourLakhActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_four_lakh, frameLayout);
                        ...
                        try {
                            ...
                            if (Table.length() > 0) {
                                ...
                                if (object.getString("plotName").trim().contains("A") || object.getString("plotName").trim().contains("B")) {
                                    ...
                                    if (((getAmount(object.getString("currentTotalPlotAmount")) - (getAmount(object.getString("totalSubmittedAmount")) - getAmount(object.getString("offerAmount"))) - (getPlotPrices(object.getString("plotArea"), object.getString("PLC"), object.getString("currentTotalPlotAmount")))) < 100000)) {
                                        new_contract_lay.setVisibility(View.GONE);
                                        new_contract_txt.setVisibility(View.GONE);
                                        note_txt.setText("1. यह ऑफर इस प्लाट पर नहीं लगाया जा सकता है , क्यूंकि इस ऑफर के हिसाब से आपको लाभ नहीं होगा\n2. यह ऑफर केवल उन्ही प्लाट के लिए वैध है जिनका बैलेंस अमाउंट ऑफर के अमाउंट से ज्यादा बन रहा है | ");
                                    } else {
                                        if (getAmount(object.getString("plotArea").trim()) >= 1000) {
                                            ...
                                            note_txt.setText("1. ₹" + getPlotPrices(object.getString("plotArea"), object.getString("PLC"), object.getString("currentTotalPlotAmount")) + " जमा करने पर  इस प्लाट का बचा हुआ पूरा पैसा EMI के हिसाब से हर महीने स्वयं ही पेड हो जायेगा\n2. अतः \u20b9 " + getPlotPrices(object.getString("plotArea"), object.getString("PLC"), object.getString("currentTotalPlotAmount")) + " जमा करने पर आपका बचा हुआ \u20b9 " + (getAmount(object.getString("currentTotalPlotAmount")) - (getAmount(object.getString("totalSubmittedAmount")) - getAmount(object.getString("offerAmount"))) - (getPlotPrices(object.getString("plotArea"), object.getString("PLC"), object.getString("currentTotalPlotAmount")))) + " ऑटो पेड हो जाएगा|");
                                        } else {
                                            new_contract_lay.setVisibility(View.GONE);
                                            new_contract_txt.setVisibility(View.GONE);
                                ...
                                plot_amount_new.setText(object.getString("currentTotalPlotAmount"));
                                ...
                                balance_new.setText("" + (getAmount(object.getString("currentTotalPlotAmount")) - (getAmount(object.getString("totalSubmittedAmount")) - getAmount(object.getString("offerAmount")))));
                                offer_amount.setText(object.getString("offerAmount"));
                                amount_to_submit.setText("" + getPlotPrices(object.getString("plotArea"), object.getString("PLC"), object.getString("currentTotalPlotAmount")));
                                amount_to_paid.setText("" + (getAmount(object.getString("currentTotalPlotAmount")) - (getAmount(object.getString("totalSubmittedAmount")) - getAmount(object.getString("offerAmount"))) - (getPlotPrices(object.getString("plotArea"), object.getString("PLC"), object.getString("currentTotalPlotAmount")))));
                            } else {
    ...
    public float getPlotPrices(String values, String plc, String total) {
        try {

            float f = Float.parseFloat(values);
            float plcs = Float.parseFloat(plc);
            float ttl = Float.parseFloat(total);
            if (plcs <= 0) {
                if (f > 1000 && f < 1250) {
                    float per_sq = ttl / f;
                    return ((f - 1000) * per_sq) + 1000 * 400;
                } else {
                    return f * 400;
                }
                ...
                if (f > 1000 && f < 1250) {
                    float per_sq = ttl / f;
                    float pp = ((f - 1000) * per_sq) + 1000 * 400;
                    return pp + ((pp * 10) / 100);
                } else {
                    return (f * 400 + (((f * 400) * 10) / 100));
                }
