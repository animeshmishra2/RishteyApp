...
public class MyReceiptActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_my_receipt, frameLayout);
    ...
    private void getReceipt(String start_date, String end_date) {
        ...
        String URL_CHECK = AGENT_RECEIPT_URL + "K9154289-68a1-80c7-e009-2asdccf7b0d" + "/" + userDetails.getAgentId() + "/" + userDetails.getuserid();
