...
public class AddNewAgentActivity extends BaseActivity {
    LinearLayout layout_1, layout_2, layout_3, layout_4, layout_5, layout_6, layout_7, layout_8;
    EditText prefix_edit, first_name, last_name, dob, phone_number, alternate_no, relative_name, relation_type, pan_no, select_agent;
    EditText aadhar_no, email, country, state, city, tehsil, area, address, house_no, landmark, pincode, whatsapp, relation;
    ...
    TextView cheque_txt, c_date_txt, c_am_txt, ref_txt, father_txt;
    CardView num_card, ref_card, am_card, date_card;
    ScrollView mainScroll;
    String add_ag_id = "", agent_ranks = "";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getLayoutInflater().inflate(R.layout.activity_add_new_agent, frameLayout);
        ...
        next_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (add_ag_id.length() < 4) {
                    Toast.makeText(getApplicationContext(), "Select Agent", Toast.LENGTH_SHORT).show();
                } else if (prefix_edit.getText().toString().length() < 2) {
        ...
        select_agent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), SelectAgentActivity.class);
        ...
        relation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(AddNewAgentActivity.this);
        ...
        dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(AddNewAgentActivity.this, R.style.MySpinnerDatePickerStyle,
        ...
        advisor_rank.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (add_ag_id.trim().length() > 2) {
                    Intent intent = new Intent(getApplicationContext(), SelectRank.class);
                    Bundle bundle = new Bundle();
                    bundle.putString("TITLE", "SELECT ADVISOR RANK");
                    bundle.putString("ID", "0");
                    bundle.putString("RANK", add_ag_id);
                    intent.putExtras(bundle);
                    startActivityForResult(intent, 112);
                } else {
                    Toast.makeText(getApplicationContext(), "Select Agent First", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void onClick(View view) {
                if (checkAndRequestPermissions()) {
                    FilePickerBuilder.getInstance()
                            ...
                            .pickPhoto(AddNewAgentActivity.this, 201);
                }
            }
        });
            ...
            public void onClick(View view) {
                if (checkAndRequestPermissions()) {
                    FilePickerBuilder.getInstance()
                            .setMaxCount(1) //optional
                            .setActivityTheme(R.style.LibAppTheme) //optional
                            .pickPhoto(AddNewAgentActivity.this, 202);
                }
            }
        });
            ...
            public void onClick(View view) {
                if (checkAndRequestPermissions()) {
                    FilePickerBuilder.getInstance()
                            .setMaxCount(1) //optional
                            .setActivityTheme(R.style.LibAppTheme) //optional
                            .pickPhoto(AddNewAgentActivity.this, 203);
                }
            }
        });
            ...
            public void onClick(View view) {
                if (checkAndRequestPermissions()) {
                    FilePickerBuilder.getInstance()
                            .setMaxCount(1) //optional
                            .setActivityTheme(R.style.LibAppTheme) //optional
                            .pickPhoto(AddNewAgentActivity.this, 204);
                }
            }
        });
            ...
            public void onClick(View view) {
                if (checkAndRequestPermissions()) {
                    FilePickerBuilder.getInstance()
                            .setMaxCount(1) //optional
                            .setActivityTheme(R.style.LibAppTheme) //optional
                            .pickPhoto(AddNewAgentActivity.this, 205);
                }
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 290 && resultCode == RESULT_OK) {
            add_ag_id = data.getExtras().getString("ID");
            select_agent.setText(data.getExtras().getString("NAME") + " - " + add_ag_id);
            agent_ranks = data.getExtras().getString("RANK");
        }
    }
    ...
    public void createJSON() {
        try {
            ...
            params.put("advisorId", add_ag_id);
            params.put("initials", prefix_edit.getText().toString());
            params.put("customerName", first_name.getText().toString() + getMidName() + last_name.getText().toString());
    ...
    public void saveAgent(String jsons) {
        pd = ProgressDialog.show(AddNewAgentActivity.this);
                ...
                try {
                    ...
                    if (Table.length() > 0) {
                        ...
                        if (!object.has("return_type")) {
                            ...
                            String mob = object.getString("MobileNo");
                            String msg = "Agent has been created successfully. Agent can now login in app and complete his profile.You can share All the details with that agent.\nLogin Mobile - " + mob + "\nLogin Password - " + pwd;
                            successDialog(msg);
                            //setLayout(8);
                        } else {
    ...
    public void successDialog(final String msg) {
        final Dialog dialog = new Dialog(AddNewAgentActivity.this);
        dialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.money_success_dialog);
    ...
    public void shareApp(String msg) {
        try {
            ...
            shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Rishtey Township Pvt Ltd");
            String shareMessage = msg + "\n\n";
            shareMessage = shareMessage + "My Rishtey Id is : " + userDetails.getuserid() + "\n" + "https://play.google.com/store/apps/details?id=" + getPackageName();
