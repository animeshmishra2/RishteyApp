...
import com.guruvardaan.ghargharsurvey.customers.InstallmentActivity;
...
public class PayForCustomerActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_pay_for_customer, frameLayout);
        c_id = "";
        sid = "";
