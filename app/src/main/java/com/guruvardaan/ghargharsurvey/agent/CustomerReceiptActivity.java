...
public class CustomerReceiptActivity extends BaseActivity {

    LinearLayout select_cust_lay;
    EditText select_customer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_customer_receipt, frameLayout);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 22 && resultCode == RESULT_OK) {
            ...
            getReceipt(getPastDate(), getCurrentDate(), cid);
        }
    }

    private void getReceipt(String start_date, String end_date, String cids) {
        no_transaction.setVisibility(View.GONE);
        progress.setVisibility(View.VISIBLE);
        recyclerView.setVisibility(View.GONE);
        String URL_CHECK = AGENT_RECEIPT_URL + "K9154289-68a1-80c7-e009-2asdccf7b0d" + "/" + userDetails.getuserid() + "/" + cids;
            ...
            if (object != null) {
                switch (object.getType()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        ((ReceiptAdapter.Row2Holder) holder).customer_name.setText(object.getCustomerFirstName());
                        ((ReceiptAdapter.Row2Holder) holder).receipt_type.setText(object.getPdfType());
                        ((ReceiptAdapter.Row2Holder) holder).amount.setText("Paid Amount : " + object.getTransaction_amount());
                        ((ReceiptAdapter.Row2Holder) holder).plot_name.setText("Plot Name : " + object.getPlotNumber());
                        ((ReceiptAdapter.Row2Holder) holder).date_txt.setText(object.getIns_dt());
                        ((ReceiptAdapter.Row2Holder) holder).download.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                downloadPDF(object.getUrl(), object.getPdfType(), "1");
                            }
                        });
                        ((ReceiptAdapter.Row2Holder) holder).share.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
