...
public class PlotCustomer {
    String name, plotName, plotRate, sqft, service_duration, mobile1, total, paid, cPending, lastAmount, dt, registeryStatus, remaining;

    public PlotCustomer(String name, String plotName, String plotRate, String sqft, String service_duration, String mobile1, String total, String paid, String cPending, String lastAmount, String dt, String registeryStatus, String remaining) {
        this.name = name;
