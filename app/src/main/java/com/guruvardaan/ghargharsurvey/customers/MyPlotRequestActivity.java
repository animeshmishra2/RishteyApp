...
import static com.guruvardaan.ghargharsurvey.config.Config.GET_PLOT_REQUEST;
...
import com.guruvardaan.ghargharsurvey.plots.PlotsActivity;
...
public class MyPlotRequestActivity extends BaseActivity {
    ...
    private void getAllRequest() {
        ...
        String URL_CHECK = GET_PLOT_REQUEST + userDetails.getuserid();
    ...
    class RequestAdapter extends RecyclerView.Adapter<RequestAdapter.RequestHolder> {
        ...
        @Override
        public void onBindViewHolder(RequestAdapter.RequestHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        @Override
        public RequestAdapter.RequestHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            LayoutInflater mInflater = LayoutInflater.from(viewGroup.getContext());
            ViewGroup mainGroup = (ViewGroup) mInflater.inflate(R.layout.my_plots_req_row, viewGroup, false);
            RequestAdapter.RequestHolder listHolder = new RequestAdapter.RequestHolder(mainGroup);
            return listHolder;
        }

        public class RequestHolder extends RecyclerView.ViewHolder {

            TextView plot_name, your_rem, emp_remark, status_txt, date_txt, view_request, buy_plots, amounts;
