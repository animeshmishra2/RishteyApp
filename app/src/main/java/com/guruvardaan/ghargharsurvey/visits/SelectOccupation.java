...
public class SelectOccupation extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_occupation, frameLayout);
    ...
    private void getProfession() {
        pd = ProgressDialog.show(SelectOccupation.this);
        String URL_CHECK = PROFESSION_URL + "K9154289-68a1-80c7-e009-2asdccf7b0d/2/" + getIntent().getExtras().getString("ID");
                        ...
                        try {
                            ...
                            if (Table.length() > 0) {
                                ...
                                for (int i = 0; i < Table.length(); i++) {
                                    ...
                                    professionModels.add(new ProfessionModel(object.getString("id"), object.getString("subOccupationName")));
                                }
